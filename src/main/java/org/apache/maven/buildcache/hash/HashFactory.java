...
public enum HashFactory {
    SHA1(new SHA("SHA-1", "SHA-1", Hash.MemoryPolicy.Standard)),
    SHA1_MM(new SHA("SHA-1+MM", "SHA-1", Hash.MemoryPolicy.MemoryMappedBuffers)),
    SHA256(new SHA("SHA-256", "SHA-256", Hash.MemoryPolicy.Standard)),
    SHA256_MM(new SHA("SHA-256+MM", "SHA-256", Hash.MemoryPolicy.MemoryMappedBuffers)),
    SHA384(new SHA("SHA-384", "SHA-384", Hash.MemoryPolicy.Standard)),
    SHA384_MM(new SHA("SHA-384+MM", "SHA-384", Hash.MemoryPolicy.MemoryMappedBuffers)),
    SHA512(new SHA("SHA-512", "SHA-512", Hash.MemoryPolicy.Standard)),
    SHA512_MM(new SHA("SHA-512+MM", "SHA-512", Hash.MemoryPolicy.MemoryMappedBuffers)),
